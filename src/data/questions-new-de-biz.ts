...
export const newDeBizQuestions: Question[] = [
  ...
  },
  {
    ...
    choices: ["許可された人だけが情報にアクセスできること", "情報が改ざんされていないこと", "必要な時にシステムが利用できること", "情報の作成者を特定できること"],
    correctIndex: 0,
  ...
  },
  {
    ...
    choices: ["バグや欠陥を早期に発見し、品質を確保すること", "開発速度を最大化すること", "ドキュメントを自動生成すること", "コードの行数を減らすこと"],
    correctIndex: 0,
  ...
  },
  {
    ...
    choices: ["プロジェクトごとにパッケージのバージョンを独立して管理するため", "Pythonの実行速度を高速化するため", "コードを自動的にテストするため", "データベースに接続するため"],
    correctIndex: 0,
